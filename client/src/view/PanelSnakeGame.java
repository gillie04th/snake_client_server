		...
		for (int i = 0; i < positions.size(); i++) {
			...
			try {
				if (featuresSnake.getColorSnake() == ColorSnake.Green) {
					...
					img = ImageIO.read(new File("./images/skins/snake_pink_" + cpt_img + ".png"));
				} else if (featuresSnake.getColorSnake() == ColorSnake.Marge) {
					img = ImageIO.read(new File("./images/skins/snake_marge_" + cpt_img + ".png"));
				} else if (featuresSnake.getColorSnake() == ColorSnake.Drunk) {
					img = ImageIO.read(new File("./images/skins/snake_drunk_" + cpt_img + ".png"));
				} else if (featuresSnake.getColorSnake() == ColorSnake.Konoha) {
					img = ImageIO.read(new File("./images/skins/snake_konoha_" + cpt_img + ".png"));
				}
